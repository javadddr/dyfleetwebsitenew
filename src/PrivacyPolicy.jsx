...
<p>Bei Ihrer Kontaktaufnahme mit uns per E-Mail oder &uuml;ber ein Kontaktformular werden die von Ihnen mitgeteilten Daten (Ihre E-Mail-Adresse, ggf. Ihr Name und Ihre Telefonnummer) von uns gespeichert, um Ihre Fragen zu beantworten. Die in diesem Zusammenhang anfallenden Daten l&ouml;schen wir, nachdem die Speicherung nicht mehr erforderlich ist, oder schr&auml;nken die Verarbeitung ein, falls gesetzliche Aufbewahrungspflichten bestehen. Rechtsgrundlage ist Art. 6 Abs. 1 S. 1 lit. f DS-GVO oder, wenn es der Erf&uuml;llung eines Vertrags oder zur Durchf&uuml;hrung vorvertraglicher Ma&szlig;nahmen dient, Art. 6 Abs. 1 S. 1 lit. b DS-GVO.</p>
...
<p>Informationen &uuml;ber den Browsertyp und die verwendete Version Das Betriebssystem des Nutzers und dessen Oberfl&auml;che Den Internet-Service-Provider des Nutzers Die IP-Adresse des Nutzers Datum und Uhrzeit des Zugriffs Websites, von denen das System des Nutzers auf unsere Website gelangt Websites, die vom System des Nutzers &uuml;ber unsere Website aufgerufen werden &Uuml;bertragene Datenmenge Zugriffsstatus/HTTP-Statuscode</p>
