  ...
  return (
    <div className={`isolate bg-white px-6 py-24 sm:py-32 lg:px-8 justify-center relative ${isLoaded ? 'animate-fadeIn' : 'opacity-0'}`}>
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-gray-600">Or directly email us at Contact@DynamoFleet.com</p>
        <p className="mt-2 text-lg leading-8 text-gray-600">Our response time typically ranges between 30 minutes and 3 hours.</p>
      </div>
